...
class Pending_Request {
	 ...
	 * Constructor.
	 */
	public function __construct( protected Test_Case $test_case ) {
		$this->app = $test_case->app();
	}
	...
	/**
	 * Set the cookies for the pending request.
	 *
	...
	/**
	 * Set the headers for the pending request.
	 *
	...
	/**
	 * Set the request body for the pending request.
	 *
	 * @param array<mixed, mixed> $body Request body.
	 * @return static
	 */
	public function with_body( array $body ): static {
		$this->body = $body;
	 ...
	 * @param string             $method     Request method.
	 * @param string             $uri        Request URI.
	 * @param array|string|null  $parameters Request params.
	 * @param array              $server     Server vars.
	 * @param array              $cookies Cookies to be sent with the request.
	 * @return Test_Response
	 */
	public function call( $method, $uri, array|string|null $parameters = [], array $server = [], array $cookies = [] ): Test_Response {
		...
		$this->set_server_state(
			...
			url: $url,
			server: $server,
			data: is_array( $parameters ) && is_array( $this->body ) ? array_merge( $this->body, $parameters ) : $parameters,
	 ...
	 * @param array|string|null  $data   POST data to set.
	 * @param array              $cookies Cookies to be sent with the request.
	 */
	protected function set_server_state( string $method, string $url, array $server, array|string|null $data, array $cookies = [] ) {
